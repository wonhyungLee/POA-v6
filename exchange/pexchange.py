...
def get_bot(
    exchange_name: Literal[
        "BINANCE", "UPBIT", "BYBIT", "BITGET", "KRX", "NASDAQ", "NYSE", "AMEX", "OKX", "BITHUMB"
    ],
    kis_number=None,
...
def check_key(exchange_name):
    ...
    elif exchange_name.startswith("KIS") and exchange_name[3:].isdigit():
        kis_num = int(exchange_name[3:])
        if 1 <= kis_num <= 50:
            ...
            raise Exception(f"KIS 번호는 1-50 사이여야 합니다")
